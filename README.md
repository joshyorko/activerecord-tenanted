...
> [!NOTE]
> Currently supported database adapters: SQLite3 and PostgreSQL. PostgreSQL supports explicit schema-based and database-based multi-tenancy strategies. If you have a use case for tenanting other databases supported by Rails, please reach out to the maintainers!
